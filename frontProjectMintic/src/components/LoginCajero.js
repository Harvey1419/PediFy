...
const LoginCajero = () => {
  ...
  const __loginCajero = async (email, password) => {
    if ((email.trim() === "" || password.trim() === "")) {
      setError(true)
    } else {
      try {
        const res = await api.loginCajero(email, password)
        if (res.token) {
    ...
    <div className="row">
      ...
      <div className="d-flex justify-content-center flex-column align-items-center col-lg-6">
        ...
        <div className="card text-center itemhome ">
          <div class="card-body">
            <h1 className="card-title ">Login Cajeros</h1>
            ...
            <span className="sepacer">
              ...
              <div className="d-flex  justify-content-around sepacer ">
                ...
                onClick={() => {__loginCajero(data.email, data.password) }}
                to={ redireccion === true ? "/Cajero" : "/LoginCajero"}  
                >
                  Entrar
                </Link>
